...
Replace this section with the supported versions for `crawldeck`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `crawldeck` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in crawldeck.
